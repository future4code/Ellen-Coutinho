    ...
    <div className="App">
      <div className="page-section-container">
        ...
        <CardGrande 
          imagem=""
          nome="Le Richter" 
          descricao="Oi, a Ellen. Sou estudante da Labenu. Adoro receber os e-mails do Astrodev e responder em cima da hora!"
        />
      ...
      <div className="page-section-container">
        <CardPequeno
          imagem=" " 
          nome="Meu email" 
          descricao="ellen@lerichter.com" 
        />
        
        <CardPequeno
          imagem=" " 
          nome="Meu endereço" 
          descricao="Rua aqui, 00 - Bairro aqui - São Roque/SP" 
        />
      </div>
      ...
      <div className="page-section-container">
        ...
        <CardGrande 
          imagem=" " 
          nome="Spada Midia" 
          descricao="Estruturas para qualquer tipo de evento!" 
        />
        
        <CardGrande 
          imagem=" " 
          nome="Related Broker" 
          descricao="Seu imóvel de alto padrão." 
        />
      </div>
